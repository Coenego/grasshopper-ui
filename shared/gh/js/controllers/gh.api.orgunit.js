...
define(['exports'], function(exports) {
     ...
     * @param  {String}      [visibility]           The visibility of the organisational unit. [draft,published]
     * @param  {Function}    [callback]             Standard callback function
     * @param  {Object}      [callback.err]         Error object containing the error code and error message
     * @param  {Object}      [callback.response]    Object representing the new organisational unit in an app
     */
    var createOrgUnit = exports.createOrgUnit = function(appId, displayName, type, parentId, groupId, description, metadata, visibility, callback) {
        ...
        } else if (visibility && !_.isString(visibility)) {
            return callback({'code': 400, 'msg': 'A valid value for visibility should be provided'});
        }
     ...
     */
    var updateOrgUnit = exports.updateOrgUnit = function(orgUnitId, description, displayName, groupId, parentId, type, metadata, visibility, callback) {
        if (callback && !_.isFunction(callback)) {
            throw new Error('A valid callback function should be provided');
        } else if (!_.isNumber(orgUnitId)) {
            return callback({'code': 400, 'msg': 'A valid orgUnitId should be provided'});
